...
@available(*, deprecated, message: "Use explicit feature products and instances; this facade is compatibility-only.")
public final class SwapFoundationKit {
    ...
    public func configure(with config: SwapFoundationKitConfiguration) throws {
        ...
        SFKSharedDefaultsRuntime.configure(appGroupIdentifier: config.appMetadata.appGroupIdentifier)
    }
    ...
    internal func resetForTesting() {
        ...
        isInitialized = false
        httpClient = nil
        SFKSharedDefaultsRuntime.reset()
    }
}
