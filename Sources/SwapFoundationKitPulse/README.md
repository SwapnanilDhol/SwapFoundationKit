...
Configure `SFKPulseService` before constructing `HTTPClient` instances so the
instrumentation seam is registered before clients are created. See [the extraction guide](../Docs/migration/v4-phase-1-product-extraction.md).
