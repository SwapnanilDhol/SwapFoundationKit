...
#ifndef SWAPFOUNDATIONKIT_SWIFT_H
#define SWAPFOUNDATIONKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SwapFoundationKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17SwapFoundationKit19ExchangeRateManager")
@interface ExchangeRateManager : NSObject <NSXMLParserDelegate>
...
SWIFT_CLASS("_TtC17SwapFoundationKit28WatchConnectivityServiceImpl")
@interface WatchConnectivityServiceImpl : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

@class WCSession;
@interface WatchConnectivityServiceImpl (SWIFT_EXTENSION(SwapFoundationKit)) <WCSessionDelegate>
